...
import { doc, runTransaction, serverTimestamp } from "https://www.gstatic.com/firebasejs/12.8.0/firebase-firestore.js";
...
if (hostNameInput && (localProfile === null || localProfile === void 0 ? void 0 : localProfile.name))
    hostNameInput.value = localProfile.name;
...
if ((_a = window.atomAccount) === null || _a === void 0 ? void 0 : _a.onAuthChange) {
    window.atomAccount.onAuthChange(async (user) => {
        ...
        try {
            ...
            if ((remote === null || remote === void 0 ? void 0 : remote.name) && hostNameInput)
                hostNameInput.value = remote.name;
...
async function createRoom() {
    ...
    const hostName = (hostNameInput === null || hostNameInput === void 0 ? void 0 : hostNameInput.value.trim().slice(0, 40)) || "Host";
    const hostTeam = (hostTeamSelect === null || hostTeamSelect === void 0 ? void 0 : hostTeamSelect.value) || "A";
    ...
    for (let attempt = 0; attempt < 5 && !created; attempt++) {
        ...
        created = await runTransaction(db, async (tx) => {
            if ((await tx.get(roomRef)).exists())
                return false;
...
//# sourceMappingURL=buzzer_create.js.map